        ...
        var i = {
            ...
            , l = function () {
                return KTEventHandler.trigger(n.element, "kt.dialer.decrease", n),
                    n.inputElement.value = n.value - n.options.step,
                    console.log("dec:" + n.inputElement.value),
                    s(),
            ...
            , s = function () {
                KTEventHandler.trigger(n.element, "kt.dialer.change", n),
                    n.value = u(n.inputElement.value),
                    console.log("min:" + n.options.min),
            ...
            , d = function (e) {
                return console.log("val:" + e),
                    n.options.prefix + parseFloat(e).toFixed(n.options.decimals) + n.options.suffix
            }
            , c = function (e) {
        ...
        var r = {
            ...
            , a = function (e) {
                ...
                !1 !== o && (o = parseInt(o),
                    ...
                    !0 === d ? (t > o && (0 === a || a < r) ? (!1 === i.hasAttribute(n.attributeName) && (l(),
                        ...
                        !0 === n.eventTriggerState && (KTEventHandler.trigger(n.element, "kt.sticky.on", n),
                            ...
                            n.eventTriggerState = !1)) : (!0 === i.hasAttribute(n.attributeName) && (s(),
                                ...
                                !1 === n.eventTriggerState && (KTEventHandler.trigger(n.element, "kt.sticky.off", n),
                                    KTEventHandler.trigger(n.element, "kt.sticky.change", n),
                                    n.eventTriggerState = !0)),
                        n.lastScrollTop = t) : t > o && (0 === a || a < r) ? (!1 === i.hasAttribute(n.attributeName) && (l(),
                            i.setAttribute(n.attributeName, "on")),
                            !0 === n.eventTriggerState && (KTEventHandler.trigger(n.element, "kt.sticky.on", n),
                                KTEventHandler.trigger(n.element, "kt.sticky.change", n),
                                n.eventTriggerState = !1)) : (!0 === i.hasAttribute(n.attributeName) && (s(),
